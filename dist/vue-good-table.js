...
Component.options.__file = "/Users/vince.rose/vue/vue-good-table/src/components/Table.vue"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_slicedToArray__ = __webpack_require__(36);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_json_stringify__ = __webpack_require__(35);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    collectFormatted: function collectFormatted(obj, column) {
      ...
      function formatDate(v) {
        ...
        return __WEBPACK_IMPORTED_MODULE_4_date_fns_format___default()(__WEBPACK_IMPORTED_MODULE_3_date_fns_parse___default()(v, column.inputFormat), column.outputFormat);
      }
    ...
    getDataStyle: function getDataStyle(index) {
      var classString = '';
    ...
    filterRows: function filterRows() {
      ...
      var computedRows = JSON.parse(__WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_json_stringify___default()(this.rows));
  ...
  computed: {
    ...
    processedRows: function processedRows() {
      ...
      if (this.sortable !== false) {
        computedRows = computedRows.sort(function (x, y) {
          ...
          var cook = function cook(x) {
            ...
            if (typeof x === 'string') {
              x = x.toLowerCase();
              if (_this3.columns[_this3.sortColumn].numeric) x = x.indexOf('.') >= 0 ? parseFloat(x) : parseInt(x);
            }
      ...
      if (this.globalSearch && !!this.searchQuery) {
        ...
        try {
          for (var _iterator3 = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_get_iterator___default()(this.rows), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
            ...
            try {
              for (var _iterator4 = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_get_iterator___default()(this.columns), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                var col = _step4.value;

                if (String(this.collectFormatted(row, col)).toLowerCase().includes(this.searchQuery.toLowerCase())) {
  ...
  mounted: function mounted() {
    this.filteredRows = JSON.parse(__WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_json_stringify___default()(this.rows));
    if (this.perPage) {
      this.currentPerPage = this.perPage;
    }
    ...
    if (this.defaultSortBy) {
      ...
      try {
        for (var _iterator5 = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_get_iterator___default()(this.columns.entries()), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Table_vue__ = __webpack_require__(31);
...
var _isIterable2 = __webpack_require__(34);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_c('thead', [(_vm.embeddedSearch) ? _c('tr', [_c('td', {
    attrs: {
    ...
    staticClass: "label"
  }, [_vm._v(_vm._s(_vm.prevText))])]), _vm._v(" "), _c('div', {
    staticClass: "info"
    ...
    staticClass: "label"
  }, [_vm._v(_vm._s(_vm.nextText))]), _vm._v(" "), _c('span', {
